...
public class FileUtils {
    ...
    public static void deleteFile(String filename) {
        ...
        try {
            ...
            if (!deleted) {
                // Delete temp file
                System.out.println("Tried to delete a temporary file used for testing, but was not able to. It may have already been deleted? "+
                        "\nIf it's still present, you may delete the file " + filename);
